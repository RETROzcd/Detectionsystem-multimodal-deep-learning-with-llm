...
if __name__ == "__main__":
    ...
    model_configs = {
        ...
        "vlm_cut_model_configs": {
            ...
            "max_image_size": 1024 #-1 #2048
        },
        "debug": True
    }
    cut_model = ImageCutModel(model_configs)
    #cut_model.cut_one_image("./samples/T52510260108TP-高拍仪/产品/20250113133920563.jpg", 
    #        "./work_dir", "123", ImageType.PRODUCT, show_path="show.jpg")

    #cut_model.cut_one_image("./samples/T52510260108TP-高拍仪/包装/20250113132118830.jpg", 
    #        "./work_dir", "123", ImageType.PRODUCT, show_path="show.jpg")
    #cut_model.cut_one_image("./samples/fromywf/外包装.jpg", 
    #        "./work_dir", "tt", ImageType.PRODUCT, show_path="show.jpg")
    cut_model.cut_one_image("./samples/玩具标签审核梳理5/产品.jpg", 
            "./work_dir", "tt", ImageType.PRODUCT, show_dir="work_dir/")